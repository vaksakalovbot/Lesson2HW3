...
struct ColorViewWithFrame: View {
    ...
    var body: some View {
        Color(UIColor(red: CGFloat(valueR/255), green: CGFloat(valueG/255), blue: CGFloat(valueB/255), alpha: 1.0))
            .frame(height: 150)
...
struct ColorViewWithFrame_Previews: PreviewProvider {
    static var previews: some View {
        ColorViewWithFrame(valueR: .constant(100), valueG: .constant(100), valueB: .constant(100))
    }
}
